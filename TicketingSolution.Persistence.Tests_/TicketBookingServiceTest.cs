...
public class TicketBookingServiceTest
{
    ...
    public void Should_Return_Available_Services()
    {
        ...
        var dbOptions = new DbContextOptionsBuilder<TicketingSolutionDbContext>()
            .UseInMemoryDatabase("AvailabeTicketTest")
            .Options;
        ...
        context.Add(new TicketBooking { TicketID = 1,Name="T1",Family="T1", Date = date });
        context.Add(new TicketBooking { TicketID=2, Name = "T1", Family = "T1", Date = date.AddDays(-1) });
